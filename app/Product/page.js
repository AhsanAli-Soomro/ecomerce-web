...
export default function HomePage() {
  ...
  return (
    <div className="homepage-container container mx-auto px-4 py-4 sm:py-8 min-h-screen">
      <ToastContainer />
      <div className={isHome?"grid grid-cols-1 lg:grid-cols-4 gap-8":"grid pt-32 grid-cols-1 lg:grid-cols-4 gap-8"}>
        {/* Filter Sidebar */}
        <motion.aside
          className="col-span-1 bg-white p-6 sm:p-8 rounded-xl shadow-lg sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto"
        ...
        {/* Product Grid */}
        <div className="col-span-1 p-4 lg:col-span-3 h-[calc(100vh-4rem)] overflow-y-auto scroll-container">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10">
