...
export default function HomePage() {
  ...
  return (
    <div className="homepage-container container mx-auto p-8 min-h-screen">
      <motion.h1
        className="text-5xl font-extrabold text-center text-gray-800 mb-12 tracking-tight"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Filter Sidebar */}
        <motion.aside
          className="col-span-1 bg-white p-8 rounded-xl shadow-lg sticky top-8"
          variants={containerVariants}
          initial="hidden"
          animate="visible"
        >
          <h2 className="text-3xl font-bold mb-8 text-gray-800">Filters</h2>
        ...
        {/* Product Grid */}
        <div className="col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-10">
              ...
              >
                <div className="relative">
                  ...
                  <img
                    src={product.image}
                    alt={product.name}
                    className="product-image w-full h-60 object-fill rounded-t-xl cursor-pointer hover:opacity-90 transition-opacity"
                  ...
                  {product.sale > 0 && (
                    <span className="absolute top-3 right-3 bg-yellow-500 text-white text-sm font-semibold px-2 py-1 rounded-full">
                      {product.sale}% OFF {/* Display sale percentage */}
                    </span>
                  )}
                </div>
                ...
                {/* Product Details */}
                <div className="px-6">
                  <h2 className="product-name text-2xl font-bold mt-2 text-gray-800 tracking-tight">
                    {product.name}
                  </h2>
                    ...
                    {product.sale > 0 ? (
                      <>
                        ...
                        <p className="text-lg font-semibold text-yellow-500">
                          ${salePrice.toFixed(2)} {/* Sale price */}
                        </p>
                      </>
                    ) : (
                      /* Display Original Price Only (No Sale) */
