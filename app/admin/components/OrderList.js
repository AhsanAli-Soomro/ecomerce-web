        ...
        <div className="max-w-7xl mx-auto p-8 min-h-screen">
            ...
            <div className="flex flex-wrap justify-center space-x-6 items-center mb-8">
                ...
                <label className="flex items-center cursor-pointer">
                    ...
                    />
                    <div
                        className={`flex items-center space-x-2 p-3 rounded-lg shadow-md transition-all ${activeStatus === 'all' ? 'bg-blue-700 text-blue-200' : 'bg-gray-700 text-gray-400'
                ...
                <label className="flex items-center cursor-pointer">
                    ...
                    />
                    <div
                        className={`flex items-center space-x-2 p-3 rounded-lg shadow-md transition-all ${activeStatus === 'pending' ? 'bg-yellow-700 text-yellow-200' : 'bg-gray-700 text-gray-400'
                ...
                <label className="flex items-center cursor-pointer">
                    ...
                    />
                    <div
                        className={`flex items-center space-x-2 p-3 rounded-lg shadow-md transition-all ${activeStatus === 'completed' ? 'bg-green-700 text-green-200' : 'bg-gray-700 text-gray-400'
